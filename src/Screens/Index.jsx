  ...
  return (
    <div>
      <div className='flex items-center justify-between h-[650px]'>
        <div className='flex items-start flex-col ml-[150px] -mt-[80px]'>
        ...
        <div><img src="https://carentoae.com/wp-content/uploads/2024/03/hero-top-12.png" alt="" className='w-[650px]'/></div>
      </div>
      <div className='w-full h-[400px] bg-[#ffffff1a] flex flex-col items-start'>
      ...
      <div className="flex items-center justify-around h-[300px]">
        ...
        <div>
          <button className='text-white bg-[#5277ba] px-4 py-3'>Book Your Car Today!</button>
        </div>
      </div>
    </div>
  )
